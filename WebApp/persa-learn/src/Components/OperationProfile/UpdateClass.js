...
import { updateOperationClass } from "../../http_Requests/operationRequests"; // Assuming operation-specific HTTP requests
...
const UpdateClass = ({
  ...
  const updateTheClass = async () => {
    ...
    if (
      ...
      let data = await updateOperationClass(details); // Use operation-specific update function
